...
# DATASET_DIR = '/scratch4/starlink/WFdata75x80/tor_fiber'
...
model_path = f'models/DF_class{NB_CLASSES}_{FEATURE}_batch{BATCH_SIZE}_epoch{NB_EPOCH}.h5'
...
csv_path = f"results/DF_class{NB_CLASSES}_{FEATURE}_batch{BATCH_SIZE}_epoch{NB_EPOCH}.csv"
...
pred_csv_path = f"results/DF_class{NB_CLASSES}_{FEATURE}_predictions_per_sample.csv"
